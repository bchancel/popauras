...
function Panel:Refresh(aura)
  ...
  -- Death Alert timing, role filters, and sounds are presentation choices.
  -- Keep these legacy controls as data adapters, but expose them in Display.
  self.frame.deathDurationLabel:SetShown(false)
  self.frame.deathDurationInput:SetShown(false)
  self.frame.deathMaxAlertsLabel:SetShown(false)
  self.frame.deathMaxAlertsInput:SetShown(false)
  self.frame.deathRolesLabel:SetShown(false)
  self.frame.deathTankCheck:SetShown(false)
  self.frame.deathHealerCheck:SetShown(false)
  self.frame.deathDPSCheck:SetShown(false)
  self.frame.deathSoundsLabel:SetShown(false)
  self.frame.deathTankSoundLabel:SetShown(false)
  self.frame.deathTankSoundDropDown:SetShown(false)
  self.frame.deathTankSoundButton:SetShown(false)
  self.frame.deathTankSoundPreview:SetShown(false)
  self.frame.deathHealerSoundLabel:SetShown(false)
  self.frame.deathHealerSoundDropDown:SetShown(false)
  self.frame.deathHealerSoundButton:SetShown(false)
  self.frame.deathHealerSoundPreview:SetShown(false)
  self.frame.deathDPSSoundLabel:SetShown(false)
  self.frame.deathDPSSoundDropDown:SetShown(false)
  self.frame.deathDPSSoundButton:SetShown(false)
  self.frame.deathDPSSoundPreview:SetShown(false)
